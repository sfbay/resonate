...
const SAMPLE_PUBLISHERS: PublisherWithLogo[] = [
  ...
  },
  {
    id: "pub-3",
    userId: "user-3",
    name: "Sing Tao Daily SF",
    logo: "/images/publishers/sing-tao.png",
    description: "Chinese-language daily newspaper serving the Bay Area Chinese community",
    website: "https://singtaousa.com",
    vendorStatus: "registered",
    vendorId: "V-12347",
    platforms: [
      { platform: "website", handle: "singtao", url: "https://singtaousa.com", followerCount: 85000, engagementRate: 1.8, verified: true },
      { platform: "facebook", handle: "SingTaoSF", url: "https://facebook.com/SingTaoSF", followerCount: 42000, engagementRate: 3.2, verified: true },
    ],
    audienceProfile: {
      ...
      demographic: { ageRanges: ["45-54", "55-64", "65-74", "75+"], primaryAgeRange: "55-64", languages: ["chinese_cantonese", "chinese_mandarin"], primaryLanguage: "chinese_cantonese" },
      economic: { incomeLevel: ["low", "moderate"], housingStatus: ["renter_rent_controlled", "homeowner"] },
      cultural: { ethnicities: ["chinese"], immigrationGeneration: ["first_gen_established", "first_gen_recent"], communityAffiliations: ["faith_buddhist", "seniors_community", "merchants_association"] },
      interests: ["Chinese news", "Local business", "Community events"],
      description: "Chinese-speaking seniors and established immigrants who rely on Chinese-language media.",
      dataSource: { methods: ["self_reported", "census_overlay"], verificationLevel: "partially_verified" },
      lastUpdated: new Date(),
    },
    rateCard: { currency: "USD", rates: [{ deliverableType: "sponsored_post", platform: "website", price: 45000 }] },
    status: "active",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  ...
  },
  {
    id: "pub-7",
    userId: "user-7",
    name: "The Potrero View",
    logo: "/images/publishers/potrero-view.png",
    description: "Neighborhood newspaper for Potrero Hill and Dogpatch",
    website: "https://potreroview.net",
    vendorStatus: "registered",
    platforms: [
      { platform: "newsletter", handle: "newsletter", url: "https://potreroview.net", followerCount: 6000, engagementRate: 42, verified: true },
      { platform: "website", handle: "potreroview", url: "https://potreroview.net", followerCount: 12000, engagementRate: 2.1, verified: true },
    ],
    audienceProfile: {
      geographic: { citywide: false, neighborhoods: ["potrero_hill", "dogpatch", "mission_bay", "south_beach"] },
      demographic: { ageRanges: ["25-34", "35-44", "45-54"], primaryAgeRange: "35-44", languages: ["english"], primaryLanguage: "english" },
      economic: { incomeLevel: ["moderate", "above_moderate"], housingStatus: ["homeowner", "renter_market_rate"] },
      cultural: { ethnicities: ["white_european", "multiracial"], communityAffiliations: ["parents_families", "artists_creatives", "neighborhood_association"] },
      interests: ["Development", "Local politics", "Community events"],
      description: "Engaged residents in rapidly changing Potrero Hill and Dogpatch neighborhoods.",
      dataSource: { methods: ["self_reported"], verificationLevel: "self_reported" },
      lastUpdated: new Date(),
    },
    rateCard: { currency: "USD", rates: [{ deliverableType: "newsletter_feature", platform: "newsletter", price: 20000 }] },
    status: "active",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    id: "pub-8",
    userId: "user-8",
    name: "Noe Valley Voice",
    logo: "/images/publishers/noe-valley-voice.png",
    description: "Community newspaper serving Noe Valley since 1977",
    website: "https://noevalleyvoice.com",
    vendorStatus: "registered",
    platforms: [
      { platform: "newsletter", handle: "newsletter", url: "https://noevalleyvoice.com", followerCount: 8000, engagementRate: 38, verified: true },
      { platform: "instagram", handle: "@noevalleyvoice", url: "https://instagram.com/noevalleyvoice", followerCount: 5500, engagementRate: 4.2, verified: true },
    ],
    audienceProfile: {
      geographic: { citywide: false, neighborhoods: ["noe_valley", "glen_park", "diamond_heights", "castro"] },
      demographic: { ageRanges: ["35-44", "45-54", "55-64"], primaryAgeRange: "45-54", languages: ["english"], primaryLanguage: "english" },
      economic: { incomeLevel: ["above_moderate"], housingStatus: ["homeowner"] },
      cultural: { ethnicities: ["white_european"], communityAffiliations: ["parents_families", "lgbtq"] },
      interests: ["Local shops", "Schools", "Community events"],
      description: "Affluent Noe Valley families with strong neighborhood identity.",
      dataSource: { methods: ["self_reported", "census_overlay"], verificationLevel: "partially_verified" },
      lastUpdated: new Date(),
    },
    rateCard: { currency: "USD", rates: [{ deliverableType: "newsletter_feature", platform: "newsletter", price: 22000 }] },
    status: "active",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
