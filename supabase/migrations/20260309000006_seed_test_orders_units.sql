-- ============================================================
-- Clean up any existing matches/orders for seed campaigns
-- (matching API may have created rows with random UUIDs)
-- ============================================================
DELETE FROM order_line_items WHERE order_id IN (
  SELECT id FROM orders WHERE campaign_id IN (
...
DELETE FROM campaign_units WHERE campaign_id IN (
  '22222222-2222-2222-2222-222222222202',
  '22222222-2222-2222-2222-222222222203',
  '22222222-2222-2222-2222-222222222204',
  '33333333-3333-3333-3333-333333333302',
...
DELETE FROM orders WHERE campaign_id IN (
  '22222222-2222-2222-2222-222222222202',
  '22222222-2222-2222-2222-222222222203',
  '22222222-2222-2222-2222-222222222204',
  '33333333-3333-3333-3333-333333333302',
...
DELETE FROM campaign_matches WHERE campaign_id IN (
  '22222222-2222-2222-2222-222222222202',
  '22222222-2222-2222-2222-222222222203',
  '22222222-2222-2222-2222-222222222204',
  '33333333-3333-3333-3333-333333333302',
...
VALUES
  ...
  ('66666666-6666-6666-6666-666666666602', '55555555-5555-5555-5555-555555555501', 'newsletter_mention', 'mailchimp', 2, 62500, 125000, 'Newsletter mentions with vaccination CTA')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('66666666-6666-6666-6666-666666666604', '55555555-5555-5555-5555-555555555504', 'sponsored_article', 'substack', 1, 200000, 200000, 'Sponsored article on community mental health')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('66666666-6666-6666-6666-666666666606', '55555555-5555-5555-5555-555555555506', 'newsletter_mention', 'mailchimp', 2, 87500, 175000, 'Newsletter features on nutrition programs')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('66666666-6666-6666-6666-666666666608', '55555555-5555-5555-5555-555555555508', 'newsletter_mention', 'mailchimp', 1, 100000, 100000, 'Know your rights newsletter feature')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('66666666-6666-6666-6666-666666666610', '55555555-5555-5555-5555-555555555512', 'sponsored_article', 'substack', 1, 130000, 130000, 'Immigration resources guide article')
ON CONFLICT (id) DO NOTHING;
